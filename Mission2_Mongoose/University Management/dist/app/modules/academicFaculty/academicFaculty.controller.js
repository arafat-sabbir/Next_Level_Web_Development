...
const createAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.default)(res, { message: 'Academic Faculty Created Successfully', data: result });
}));
const getAllAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, sendResponse_1.default)(res, { message: 'Academic Faculty Retrieved Successfully', data: result });
}));
...
const updateSingleAcademicFaculty = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_service_1.AcademicFacultyServices.updateSingleAcademicFacultyFromDb(req.params.facultyId, req.body);
